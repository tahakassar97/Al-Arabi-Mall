...
public class UpdateProfileController implements Callback<JsonObject> {

    Context context;
    ProgressDialog dialog;

    public void start(Context context, RequestBody service,
                      RequestBody userID, RequestBody name,
                      RequestBody username, RequestBody password,
                      RequestBody lat, RequestBody lng) {
        ...
        dialog.show();
        Call<JsonObject> call = apiInterface.updateProfile(service, username, password, name, lat, lng, userID);
        call.enqueue(this);
    }
